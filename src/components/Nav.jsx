              ...
              <ul className="navbar-nav ms-auto">
                ...
                <li className="nav-item">
                  ...
                  >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"  class="bi bi-brightness-high-fill" viewBox="0 0 16 16">
                    ...
                    <div 
                        className={`toggler-slider ${props.light?"light":""}`}
                        onClick={props.toggleLightMode}
                        >
                        <div className="toggler-slider-circle"></div>
                    </div>
                    <p className="toggler-dark">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-moon-stars-fill" viewBox="0 0 16 16">
