        ...
        <SocialMedia/>
          <div className="row  align-items-center pb-4">
              <div className="col-md-6 text-start">
                ...
                <button className='btn mt-lg-5  btn-resume ms-md-3' type="button" value="" >
                  Resume
                  <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-arrow-down" viewBox="0 0 16 16">
