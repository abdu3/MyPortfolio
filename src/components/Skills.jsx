...
export default function Skills(props) {
  return (
        <section className={`skills pt-5 pb-5 text-center ${props.light?"light":""}`}>
            ...
            <div className="skills-svg-box">
                <svg preserveAspectRatio="none" width="1440" height="74" viewBox="0 0 270 64" className="sc-c8cfb853-4 skills-svg">
